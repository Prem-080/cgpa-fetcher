function Results({ studentName, cgpa, sgpa, screenshots }) {
  return (
    <div className="w-full lg:flex-1 space-y-6">
      {(studentName || cgpa) && (
        <div className="bg-white p-4 sm:p-5 md:p-6 rounded-xl shadow-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
            {cgpa && (
              <div className="result-card text-center p-3 sm:p-4 md:p-6 bg-gradient-to-br from-green-50 to-blue-50 rounded-lg sm:rounded-xl border border-green-100 shadow-md hover:shadow-lg transition-all duration-300">
            ...
            {sgpa && (
              <div className="result-card text-center p-3 sm:p-4 md:p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg sm:rounded-xl border border-blue-100 shadow-md hover:shadow-lg transition-all duration-300">
                <div className="text-sm sm:text-base font-medium text-gray-600 mb-1 sm:mb-2">
                  SGPA
                </div>
      ...
      {screenshots.length > 0 && (
        <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg animate-fadeIn">
          <h2 className="font-semibold mb-4 flex items-center gap-2 text-lg">
            <span className="text-xl">📸</span> Screenshots ({screenshots.length})
          </h2>
              ...
              <div key={s.name} className="screenshot-item group">
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-all duration-300 flex items-center justify-center pointer-events-none">
                    <span className="text-white text-sm opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 bg-black/75 px-3 py-2 rounded-full">
                      📥 Download Screenshot
                    </span>
                  </div>
                </a>
